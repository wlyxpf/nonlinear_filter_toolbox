...
% @DD1 - divided difference filter 1st order
% input parameters
%  #1 system
%  #2 lag
%  #3 px0
...
%       - recomended setting is h = sqrt(3) for Divided Difference Filter
%         or h = 1 for Central Difference Filter
%       - for details see references in @dd1/dd1.m
%
%  
...
case 1
  ...
  if isa(varargin{1},'dd1')
    p = varargin{1};
  else
    error('nft2:dd:ia_n_dd1','Input argument is not a dd1 object ');
 end    
 case {2,3,4}
  % specification of DD1   
