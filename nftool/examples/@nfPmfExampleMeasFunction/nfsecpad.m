...
switch nargin
    ...
    case {3,4}
        ...
        % partial derivatives:
        %    d^2f/dx_1dx_1 = 0.4*x_2
        %    d^2f/dx_1dx_2 = 0.4*x_1
        %    d^2f/dx_2dx_1 = 0.4*x_1
        %------------------------------------------------------------------        
        ...
        for secondQuantity = 1:numberOfSecondVariables
            for firstQuantity = 1:numberOfFirstVariables
                if (firstVariablesIndex(firstQuantity) == 1 && secondVariablesIndex(secondQuantity) == 1 )
                    secondPartialDerivative(:,matrixColumnBegin)= 0.4*point(2);% d^2f/dx_1dx_1
                end
                if (firstVariablesIndex(firstQuantity) == 2 && secondVariablesIndex(secondQuantity) == 1 )
                    secondPartialDerivative(:,matrixColumnBegin)= 0.4*point(1);% d^2f/dx_1dx_2
                end
                if (firstVariablesIndex(firstQuantity) == 1 && secondVariablesIndex(secondQuantity) == 2 )
                    secondPartialDerivative(:,matrixColumnBegin)= 0.4*point(1);% d^2f/dx_2dx_1
                end
