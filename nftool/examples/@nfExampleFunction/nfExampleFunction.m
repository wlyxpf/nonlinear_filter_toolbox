function p = nfExampleFunction()
% nfExampleFunction - nfExampleFunction constructor
%
% The nfExampleFunctiondefines folloving nonlinear multivariate function
%
%      | x1^2*x2+w1 |           | x1 |                  | w1 |
...
p.nffun = '[x1^2*x2+w1;x2+w2]';       % necessary for display method
...
p = class(p,'nfExampleFunction',NFFUNCTION);
